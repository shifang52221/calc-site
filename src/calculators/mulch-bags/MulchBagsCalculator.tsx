...
import { calculateMulchBags } from "./calc";
...
type BagPresetId = "1.5" | "2" | "3" | "custom";
...
export function MulchBagsCalculator() {
  const t = useTranslations("mulchBags");
  ...
  const bagPreset: BagPresetId =
    bagPresetRaw === "1.5" || bagPresetRaw === "2" || bagPresetRaw === "3" || bagPresetRaw === "custom"
      ? bagPresetRaw
      : defaultBagPreset;
      ...
      <CalculatorCard title={t("title")} subtitle={t("subtitle")}>
        <div className="grid gap-4">
          ...
          <label className="grid gap-1 text-sm">
            ...
            >
              <option value="1.5">{t("bagPresets.cuft15")}</option>
          ...
          <CalculatorField
            ...
            placeholder={bagPreset === "custom" ? (unitSystem === "metric" ? "e.g. 50" : "e.g. 2") : undefined}
          />
