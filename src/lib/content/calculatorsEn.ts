...
export const CALCULATOR_CONTENT_EN: Record<CalculatorId, CalculatorContentBlock> =
  {
    ...
    concreteBags: {
      ...
      howToMeasureSteps: [
        ...
        "If you’re mixing bag sizes, convert each to cubic feet per bag and add volumes before you round up.",
    ...
    baseboardTrim: {
      quick: [
        "Start with total wall perimeter, then subtract door openings where baseboard stops at casing.",
        "Choose the actual stock length you plan to buy (commonly 8 ft, 12 ft, or 16 ft) to estimate piece count.",
        "Add waste for miter cuts, outside corners, scarf joints, damaged ends, and defects (often 5-10% for simple rooms).",
        ...
        "Plan your joint strategy (scarf joints, coping vs miters) before buying exact linear feet.",
        "For a tighter order, sketch long walls first so seams land in less-visible places and offcuts can be reused.",
      ],
      deepDiveTitle: "Linear feet is only the first trim number",
      deepDive: [
        "A baseboard trim calculator gives the linear-feet baseline, but the real purchase is usually full molding pieces. Door deductions, stock length, and joint layout decide whether that baseline becomes enough usable trim.",
        ...
        "A 12 ft piece may be better on a long living-room wall because it removes a visible seam. The same 12 ft piece may waste more in a small powder room with several short runs. That is why piece count should be checked after you choose the stock length.",
        ...
        "Worked example: if your measured baseboard run is 146 linear ft after subtracting doors, 12 ft stock gives 146 / 12 = 12.2, so 13 pieces before waste. With a 10% planning buffer, target about 161 linear ft total, which is 14 pieces of 12 ft stock.",
        "Second example: the same 146 linear ft in 8 ft stock is 18.25 pieces before waste, so you round to 19 pieces. With 10% waste, the order becomes about 161 ft / 8 = 20.1, so 21 pieces. The lower handling hassle may be worth the extra seam planning, but it changes the cart total.",
      ],
      howToMeasureTitle: "How to estimate baseboard and trim",
      howToMeasureSteps: [
        "Measure room perimeter (sum of all wall lengths), then subtract each door width where baseboard stops at casing.",
        "Decide if you're trimming closets and alcoves—include those lengths if needed.",
        "Choose the stock length you can buy and transport, then convert total length into pieces and round up.",
        "Count inside and outside corners. More outside corners typically means more waste because both pieces need clean miter cuts.",
        ...
        "Mark special breaks such as fireplaces, stair landings, built-ins, and door returns because they can consume short pieces that do not show up in simple perimeter math.",
      ],
      assumptionsTitle: "Assumptions to double-check",
      assumptions: [
        ...
        "This estimate assumes one profile and one stock length. If you mix tall baseboard, shoe molding, casing, or crown, estimate each profile separately.",
      ],
      buyingTipsTitle: "Buying tips",
      buyingTips: [
        ...
        "Before buying longer stock, confirm vehicle, elevator, stair, and room access. Long pieces reduce seams only if you can move and store them without damage.",
      ],
      commonMistakesTitle: "Common mistakes to avoid",
      commonMistakes: [
        ...
        "Counting all wall perimeter but forgetting that door casing, built-ins, and stair transitions break the run into shorter pieces.",
      ],
    ...
    drywallMudTape: {
      ...
      howToMeasureSteps: [
        ...
        "If you have many butt joints or plan a Level 5 finish, expect wider feathering and more compound per seam.",
    ...
    sand: {
      ...
      howToMeasureSteps: [
        ...
        "For paver bedding, use the final screeded thickness (often about 1 inch), not the loose pile height.",
        "If you plan to compact, estimate depth as the final compacted thickness and add loose material for compaction loss.",
    ...
    wallpaperRolls: {
      ...
      howToMeasureSteps: [
        ...
        "Add a trim allowance (2-4 inches) to wall height for each strip before calculating drops.",
    ...
    deckMud: {
      quick: [
        ...
        "Use a common dry pack mortar ratio (often 5:1 sand to cement) or a 4:1 mud bed mix where your system calls for it, and round up.",
        "If you are using bagged floor mud or a pre-blended dry pack product, use the label yield before generic bag-count rules.",
      ...
      deepDive: [
        ...
        "For square-foot estimates, start with the surface area, then choose the average thickness. A 40 sq ft shower pan at 1.5\" average thickness needs 40 x 1.5 / 12 = 5 cu ft before waste.",
        ...
        "Floor mud calculator searches usually mean the same deck mud math: area, thickness, slope, and bag yield. The product name can vary, but the volume-first estimate stays the same.",
        ...
        "If your system uses a 4 to 1 mud bed mix instead of 5 to 1, keep the same area and thickness math but adjust the sand/cement split to match the specified ratio.",
        ...
        "Terminology note: people may search for deck mud, dry pack mortar, floor mud, or mud bed calculator. The estimating math is the same volume-first approach, but product choice and minimum thickness still come from the tile or waterproofing system.",
      ],
      ...
      howToMeasureSteps: [
        ...
        "If you have only a square-foot target, convert thickness to feet first or use the shortcut: cubic feet = square feet x inches / 12.",
        ...
        "If you're following a 4 to 1 mud bed mix recipe, keep the same volume and slope math, then change only the sand-to-cement split the system specifies.",
      ],
      assumptionsTitle: "Assumptions to double-check",
      assumptions: [
