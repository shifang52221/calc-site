...
import { TopsoilBagsCalculator } from "@/calculators/topsoil-bags/TopsoilBagsCalculator";
...
export async function generateMetadata({
  ...
  const t = await getTranslations("topsoilBags");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/calculators/home-improvement/topsoil-bags"),
    robots: isReviewNoindexCalculator(locale, "topsoilBags")
      ? { index: false, follow: true }
      : undefined,
  };
}

export default async function TopsoilBagsPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/topsoil-bags"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorContent locale={locale} calculatorId="topsoilBags" variant="before" />

      <TopsoilBagsCalculator />

      <AdSlot slot={ADSENSE_SLOTS.calculatorAfterResult} />

      <CalculatorContent locale={locale} calculatorId="topsoilBags" variant="after" />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="topsoilBags" />
