...
export async function generateMetadata({
  ...
  const t = await getTranslations("gravel");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/calculators/home-improvement/gravel"),
    robots: isReviewNoindexCalculator(locale, "gravel")
...
export default async function GravelPage({
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/gravel"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorContent locale={locale} calculatorId="gravel" variant="before" />
      ...
      <CalculatorReferenceSection locale={locale} calculatorId="gravel" />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="gravel" />
