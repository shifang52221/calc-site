...
export async function generateMetadata({
  ...
  const t = await getTranslations("boardFeet");
...
export default async function BoardFeetPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/board-feet"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorContent locale={locale} calculatorId="boardFeet" variant="before" />

      <BoardFeetCalculator />

      <AdSlot slot={ADSENSE_SLOTS.calculatorAfterResult} />

      <CalculatorContent locale={locale} calculatorId="boardFeet" variant="after" />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="boardFeet" />
