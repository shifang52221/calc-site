...
import { DeckCalculator } from "@/calculators/deck/DeckCalculator";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: getAlternates(locale, "/calculators/home-improvement/deck"),
    robots: isReviewNoindexCalculator(locale, "deck")
...
export default async function DeckPage({
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/deck"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorContent locale={locale} calculatorId="deck" variant="before" />

      <DeckCalculator />

      <AdSlot slot={ADSENSE_SLOTS.calculatorAfterResult} />

      <CalculatorContent locale={locale} calculatorId="deck" variant="after" />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="deck" />
