...
import { WallpaperRollsCalculator } from "@/calculators/wallpaper-rolls/WallpaperRollsCalculator";
...
export async function generateMetadata({
  ...
  const t = await getTranslations("wallpaperRolls");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/calculators/home-improvement/wallpaper-rolls"),
    robots: isReviewNoindexCalculator(locale, "wallpaperRolls")
      ? { index: false, follow: true }
      : undefined,
  };
}

export default async function WallpaperRollsPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/wallpaper-rolls"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="wallpaperRolls" />
