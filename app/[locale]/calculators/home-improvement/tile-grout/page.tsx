...
export async function generateMetadata({
  ...
  const t = await getTranslations("tileGrout");
...
export default async function TileGroutPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/tile-grout"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorContent locale={locale} calculatorId="tileGrout" variant="before" />

      <TileGroutCalculator />

      <AdSlot slot={ADSENSE_SLOTS.calculatorAfterResult} />

      <CalculatorContent locale={locale} calculatorId="tileGrout" variant="after" />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="tileGrout" />
