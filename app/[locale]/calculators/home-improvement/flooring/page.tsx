...
import { FlooringCalculator } from "@/calculators/flooring/FlooringCalculator";
...
export async function generateMetadata({
  ...
  const t = await getTranslations("flooring");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/calculators/home-improvement/flooring"),
    robots: isReviewNoindexCalculator(locale, "flooring")
...
export default async function FlooringPage({
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/flooring"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorContent locale={locale} calculatorId="flooring" variant="before" />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="flooring" />
