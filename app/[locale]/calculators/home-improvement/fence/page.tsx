...
import { FenceCalculator } from "@/calculators/fence/FenceCalculator";
...
export async function generateMetadata({
  ...
  const t = await getTranslations("fence");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/calculators/home-improvement/fence"),
    robots: isReviewNoindexCalculator(locale, "fence")
...
export default async function FencePage({
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/fence"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorContent locale={locale} calculatorId="fence" variant="before" />

      <FenceCalculator />

      <AdSlot slot={ADSENSE_SLOTS.calculatorAfterResult} />

      <CalculatorContent locale={locale} calculatorId="fence" variant="after" />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="fence" />
