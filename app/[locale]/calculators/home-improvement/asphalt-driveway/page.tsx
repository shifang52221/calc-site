...
import { AsphaltDrivewayCalculator } from "@/calculators/asphalt-driveway/AsphaltDrivewayCalculator";
...
export async function generateMetadata({
  ...
  const t = await getTranslations("asphaltDriveway");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/calculators/home-improvement/asphalt-driveway"),
    robots: isReviewNoindexCalculator(locale, "asphaltDriveway")
      ? { index: false, follow: true }
      : undefined,
  };
}

export default async function AsphaltDrivewayPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="grid gap-8">
      <CalculatorSeoJsonLd
        locale={locale}
        pathname="/calculators/home-improvement/asphalt-driveway"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <CalculatorRelatedSection locale={locale} calculatorId="asphaltDriveway" />
