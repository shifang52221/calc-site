...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: getAlternates(locale, "/guides/home-improvement/drywall"),
  };
}

export default async function DrywallGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      ...
      <GuideExtraContent locale={locale} guideId="drywall" />

      <GuideReferenceSection locale={locale} guideId="drywall" />
      ...
      <GuideRelatedSection locale={locale} guideId="drywall" />
