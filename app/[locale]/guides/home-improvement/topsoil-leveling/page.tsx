...
export default async function TopsoilLevelingGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const breadcrumbs = [
    ...
    {
      name: cards("topsoilLevelingTitle"),
      url: getLocalizedUrl(locale, "/guides/home-improvement/topsoil-leveling"),
    },
  ];
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      ...
      <GuideExtraContent locale={locale} guideId="topsoil-leveling" />
