...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideFlooringBoxes");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/flooring-boxes"),
  };
}

export default async function FlooringBoxesGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/flooring-boxes"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="flooring-boxes" />

      <GuideReferenceSection locale={locale} guideId="flooring-boxes" />
      ...
      <GuideRelatedSection locale={locale} guideId="flooring-boxes" />
