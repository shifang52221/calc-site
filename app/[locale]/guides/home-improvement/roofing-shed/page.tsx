...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideRoofingShed");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/roofing-shed"),
  };
}

export default async function RoofingShedGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const breadcrumbs = [
    ...
    {
      name: cards("roofingShedTitle"),
      url: getLocalizedUrl(locale, "/guides/home-improvement/roofing-shed"),
    },
  ];
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      ...
      <GuideRelatedSection locale={locale} guideId="roofing-shed" />
