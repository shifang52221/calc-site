...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideRoofing");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/roofing"),
  };
}

export default async function RoofingGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/roofing"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="roofing" />

      <GuideReferenceSection locale={locale} guideId="roofing" />
      ...
      <GuideRelatedSection locale={locale} guideId="roofing" />
