...
export async function generateMetadata({
  ...
  const t = await getTranslations("guidePaintTrim");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/paint-trim"),
  };
}

export default async function PaintTrimGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/paint-trim"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="paint-trim" />

      <GuideReferenceSection locale={locale} guideId="paint-trim" />
      ...
      <GuideRelatedSection locale={locale} guideId="paint-trim" />
