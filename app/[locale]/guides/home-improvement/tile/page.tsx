...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideTile");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/tile"),
  };
}

export default async function TileGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/tile"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="tile" />

      <GuideReferenceSection locale={locale} guideId="tile" />
      ...
      <GuideRelatedSection locale={locale} guideId="tile" />
