...
export async function generateMetadata({
  ...
  const t = await getTranslations("guidePaintCeiling");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/paint-ceiling"),
  };
}

export default async function PaintCeilingGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/paint-ceiling"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="paint-ceiling" />

      <GuideReferenceSection locale={locale} guideId="paint-ceiling" />
      ...
      <GuideRelatedSection locale={locale} guideId="paint-ceiling" />
