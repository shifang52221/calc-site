...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: getAlternates(locale, "/guides/home-improvement/deck"),
  };
}
...
export default async function DeckGuidePage({
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/deck"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="deck" />

      <GuideReferenceSection locale={locale} guideId="deck" />
      ...
      <GuideRelatedSection locale={locale} guideId="deck" />
