...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideFencePosts");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/fence-posts"),
  };
}

export default async function FencePostsGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/fence-posts"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="fence-posts" />

      <GuideReferenceSection locale={locale} guideId="fence-posts" />
      ...
      <GuideRelatedSection locale={locale} guideId="fence-posts" />
