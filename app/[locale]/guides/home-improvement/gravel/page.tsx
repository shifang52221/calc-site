...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideGravel");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/gravel"),
  };
}

export default async function GravelGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/gravel"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="gravel" />

      <GuideReferenceSection locale={locale} guideId="gravel" />
      ...
      <GuideRelatedSection locale={locale} guideId="gravel" />
