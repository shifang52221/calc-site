...
export default async function DrywallCeilingGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const breadcrumbs = [
    ...
    {
      name: cards("drywallCeilingTitle"),
      url: getLocalizedUrl(locale, "/guides/home-improvement/drywall-ceiling"),
    },
  ];
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      ...
      <GuideExtraContent locale={locale} guideId="drywall-ceiling" />
