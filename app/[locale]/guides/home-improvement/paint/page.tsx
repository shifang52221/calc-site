...
export async function generateMetadata({
  ...
  const t = await getTranslations("guidePaint");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/paint"),
  };
}

export default async function PaintGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/paint"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="paint" />

      <GuideReferenceSection locale={locale} guideId="paint" />
      ...
      <GuideRelatedSection locale={locale} guideId="paint" />
