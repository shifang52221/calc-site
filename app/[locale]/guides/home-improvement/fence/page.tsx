...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideFence");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/fence"),
  };
}

export default async function FenceGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/fence"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="fence" />

      <GuideReferenceSection locale={locale} guideId="fence" />
      ...
      <GuideRelatedSection locale={locale} guideId="fence" />
