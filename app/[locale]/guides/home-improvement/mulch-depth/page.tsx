...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideMulchDepth");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/mulch-depth"),
  };
}

export default async function MulchDepthGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/mulch-depth"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="mulch-depth" />

      <GuideReferenceSection locale={locale} guideId="mulch-depth" />
      ...
      <GuideRelatedSection locale={locale} guideId="mulch-depth" />
