...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideGravelTons");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/gravel-tons"),
  };
}

export default async function GravelTonsGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/gravel-tons"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="gravel-tons" />

      <GuideReferenceSection locale={locale} guideId="gravel-tons" />
      ...
      <GuideRelatedSection locale={locale} guideId="gravel-tons" />
