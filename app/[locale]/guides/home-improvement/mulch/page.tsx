...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideMulch");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/mulch"),
  };
}

export default async function MulchGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      <GuideSeoJsonLd
        locale={locale}
        pathname="/guides/home-improvement/mulch"
        title={t("metaTitle")}
        description={t("metaDescription")}
        faq={faq}
      />
      ...
      <GuideExtraContent locale={locale} guideId="mulch" />

      <GuideReferenceSection locale={locale} guideId="mulch" />
      ...
      <GuideRelatedSection locale={locale} guideId="mulch" />
