...
export async function generateMetadata({
  ...
  const t = await getTranslations("guideTileWaste");

  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates(locale, "/guides/home-improvement/tile-waste"),
  };
}

export default async function TileWasteGuidePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const breadcrumbs = [
    ...
    {
      name: cards("tileWasteTitle"),
      url: getLocalizedUrl(locale, "/guides/home-improvement/tile-waste"),
    },
  ];
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-8">
      ...
      <GuideRelatedSection locale={locale} guideId="tile-waste" />
