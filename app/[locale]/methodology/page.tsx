...
export default async function MethodologyPage({
  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-6">
      ...
      <section className="grid gap-3 rounded-xl border border-zinc-200 bg-white p-5 text-sm text-zinc-700 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300">
        <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">
          {t("reviewProcessTitle")}
        </h2>
        <ul className="grid list-disc gap-2 pl-5">
          <li>{t("reviewProcess.r1")}</li>
          <li>{t("reviewProcess.r2")}</li>
          <li>{t("reviewProcess.r3")}</li>
        </ul>
      </section>
      ...
      <section className="grid gap-3 rounded-xl border border-zinc-200 bg-white p-5 text-sm text-zinc-700 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300">
        ...
        <ul className="grid list-disc gap-2 pl-5">
          <li>{t("uncertainty.u1")}</li>
          <li>{t("uncertainty.u2")}</li>
          <li>{t("uncertainty.u3")}</li>
        </ul>
      </section>
